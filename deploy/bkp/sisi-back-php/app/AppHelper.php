...
class AppHelper
{
     ...
     * @return bool
     */
    public static function verifySpacesEmpty(string $string){
    ...
    public static function transformData(string $string){
        if(strlen($string) == 8){
            return substr($string, 0, 2).'/'.substr($string, 2, 2).'/'.substr($string, 4, 4);
